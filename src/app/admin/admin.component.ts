...
export class AdminComponent implements OnInit {
  ...
  setNextSaturday() {
    ...
    console.log(this.tagelerForm.controls['checkout']);
    console.log(this.tagelerForm);
    this.tagelerForm.controls['checkout'].controls['deadline_date'].setValue(sat.toISOString().substr(0, 10));
  }
